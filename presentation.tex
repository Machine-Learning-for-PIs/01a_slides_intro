...
\title{Welcom to the Machine Learning for Principal Investigators Course}
\date{\today}
...
\begin{document}
    ...
    \begin{frame}{Github Classroom}
      \begin{itemize}
        ...
        \item After the course download the material or create a fork in your account for long term acces.
    ...
    \begin{frame}{Course Philosophy}
      \begin{itemize}
        ...
        \item Learn how to supervise with software engineering, best practices in mind. 
      \end{itemize}
    \end{frame}
